...
-- This is a classic star schema design: fact table (trips) joined to dimension table (locations)
...
left join {{ ref('dim_locations') }} as pz
    on trips.pickup_location_id = pz.location_id
left join {{ ref('dim_locations') }} as dz
