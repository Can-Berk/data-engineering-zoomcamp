# workshop/src/job/q5_session_longest_streak.py
...
def create_events_source_kafka(t_env):
    ...
    source_ddl = f"""
        CREATE TABLE {table_name} (
            ...
            'properties.group.id' = 'green-trips-flink-group-q5',
...
def log_session_aggregation():
    ...
    try:
        ...
        print("Writing session-window records from Kafka to JDBC failed:", str(e))
